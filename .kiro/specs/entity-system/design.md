 ...
 */
export function generateTypes(entityName: string, entityDef: EntityDefinition): string {
...
function generateUpdateDTO(name: string, def: EntityDefinition): string {
  return `
...
```typescript
export function generateListPage(entityName: string, entityDef: EntityDefinition): string {
...
```typescript
export function generateFormPage(entityName: string, entityDef: EntityDefinition): string {
...
function generateListRoute(entityName: string, entityDef: EntityDefinition): string {
  const code = `
 ...
 */
export function validateField(value: any, fieldDef: FieldDefinition): string | null {
  // Required check
...
const enumFields = Object.entries(entityDef.fields).filter(([_, def]) => def.type === 'enum');
